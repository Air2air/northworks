...
interface PublicationsSlugPageProps {
  params: Promise<{ slug: string }>;
}

export async function generateMetadata({ params }: PublicationsSlugPageProps): Promise<Metadata> {
...
export default async function PublicationsSlugPage({ params }: PublicationsSlugPageProps) {
  const { slug } = await params;
