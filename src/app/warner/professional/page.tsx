  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Simple list of professional content */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projectsContent.map((content) => (
            <article key={content.slug} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <Link href={`/warner/professional/${content.slug}`}>
                <div className="p-6">
        ...
        {projectsContent.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-600">No professional content available at this time.</p>
          </div>
        )}
      </div>
    </div>
