...
interface ProfessionalSlugPageProps {
  params: Promise<{ slug: string }>;
}

export async function generateMetadata({ params }: ProfessionalSlugPageProps): Promise<Metadata> {
...
export default async function ProfessionalSlugPage({ params }: ProfessionalSlugPageProps) {
  const { slug } = await params;
