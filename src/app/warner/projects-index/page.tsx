...
export default function ProjectsIndexPage() {
  // Get project content using our new pattern
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <PageTitle
          ...
          description="Complete index of D. Warner North's professional projects and consulting work."
          align="center"
          size="medium"
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projectsContent.map((project) => (
            <article key={project.slug} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <Link href={`/warner/projects/${project.slug}`}>
                <div className="p-6">
